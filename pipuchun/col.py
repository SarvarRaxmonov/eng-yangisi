...
TOKENn = '1979983147:AAHLpsnacI62z5YoXDMdRoMJmzeF0Lx38p0'
logging.basicConfig(level=logging.INFO)
from markups import i
...
for i in range (25, 56):  
       @dp.callback_query_handler(text=f"sura{i}")
       async def sura(message: types.Message):
              await bot.delete_message(message.from_user.id,  message.message.message_id)
              ...
              await bot.send_message(message.from_user.id,f"{orqaga}",parse_mode='HTML' , reply_markup=nav.ortgaMaherAlMeaqli1)
...
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/42'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/43'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/44'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/45'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/46'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/47'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/48'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/49'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/50'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/51'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/52'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/53'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/54'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/55'>ㅤ</a>",parse_mode='HTML' )
       await bot.send_message(message.from_user.id,"<a href='https://t.me/b148uz/56'>ㅤ</a>",parse_mode='HTML' )
...
@dp.callback_query_handler(text="MaherAlMeaqlisuralar19")
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
...
@dp.callback_query_handler(text="MaherAlMeaqlisuralar20")
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
...
@dp.callback_query_handler(text="MaherAlMeaqlisuralar21")
async def sura(message: types.Message):
       await bot.delete_message(message.from_user.id,  message.message.message_id)
...
async def sura(message: types.Message):
       #await bot.delete_message(message.from_user.id,  message.message.message_id)
       await message.message.edit_text(f"<b>Qori:</b> Maher Al Meaqli (ماهر المعيقلي) {cd} ",parse_mode='HTML' , reply_markup=nav.allsuralarMaherAlMeaqli)
